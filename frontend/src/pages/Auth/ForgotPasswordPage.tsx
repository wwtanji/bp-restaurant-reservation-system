          ...
          {!submitted ? (
            <>
              <div className="text-center mb-8">
                <h2 className="text-2xl font-extrabold text-ot-charade">Forgot Password?</h2>
                <p className="mt-2 text-sm text-ot-pale-sky">
            ...
            <div className="text-center">
              ...
              <h2 className="text-2xl font-extrabold text-ot-charade mb-4">Check Your Email</h2>

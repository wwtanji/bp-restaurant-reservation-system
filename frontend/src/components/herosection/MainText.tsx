...
import { PARTY_SIZES, TIME_OPTIONS, todayISO, formatDate } from '../../constants/reservation';
        ...
        <form onSubmit={handleSearch}>
          <div className="flex items-center gap-3 flex-wrap lg:flex-nowrap">
            <div className="flex items-center gap-2 border border-ot-iron dark:border-dark-border rounded-ot-btn px-3 py-2.5 bg-white dark:bg-dark-surface min-w-[160px]">
              <svg
                className="w-5 h-5 text-ot-charade dark:text-dark-text flex-shrink-0"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={1.5}
            ...
            <div className="flex items-center gap-2 border border-ot-iron dark:border-dark-border rounded-ot-btn px-3 py-2.5 bg-white dark:bg-dark-surface flex-1 min-w-[200px]">
              <svg
                className="w-5 h-5 text-ot-manatee dark:text-dark-text-secondary flex-shrink-0"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}

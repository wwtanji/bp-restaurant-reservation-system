              ...
              <table className="w-full text-sm table-fixed">
                <thead>
                  <tr className="border-b border-ot-iron dark:border-dark-border bg-ot-athens-gray dark:bg-dark-surface">
                    <th className="text-left px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[18%]">Name</th>
                    <th className="text-left px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[24%]">Email</th>
                    <th className="text-left px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[10%]">Role</th>
                    <th className="text-left px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[10%]">Status</th>
                    <th className="text-left px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[10%]">Joined</th>
                    <th className="text-right px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[28%]">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {(users ?? []).map(u => {
                    ...
                    return (
                      <tr key={u.id} className="border-b border-ot-iron/50 dark:border-dark-border last:border-0">
                        <td className="px-3 py-2.5 font-medium text-ot-charade dark:text-dark-text truncate">
                          {u.first_name} {u.last_name}
                        </td>
                        <td className="px-3 py-2.5 text-gray-500 dark:text-dark-text-secondary truncate" title={u.user_email}>
                          {u.user_email}
                        </td>
                        ...
                        <td className="px-3 py-2.5">
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            {isSelf && (
                              <span className="text-xs text-gray-400 dark:text-dark-text-secondary italic">You</span>
                            )}
                          </div>
                        </td>
                      </tr>

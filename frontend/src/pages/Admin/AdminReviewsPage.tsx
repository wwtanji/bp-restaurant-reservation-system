              ...
              <table className="w-full text-sm table-fixed">
                <thead>
                  <tr className="border-b border-ot-iron dark:border-dark-border bg-ot-athens-gray dark:bg-dark-surface">
                    <th className="text-left px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[16%]">Author</th>
                    <th className="text-left px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[14%]">Restaurant</th>
                    <th className="text-left px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[12%]">Rating</th>
                    <th className="text-left px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[32%]">Review</th>
                    <th className="text-left px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[10%]">Date</th>
                    <th className="text-right px-3 py-2.5 font-medium text-gray-500 dark:text-dark-text-secondary w-[16%]">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {(reviews ?? []).map(r => (
                    <tr key={r.id} className="border-b border-ot-iron/50 dark:border-dark-border last:border-0 hover:bg-ot-athens-gray/50 dark:hover:bg-dark-surface/50 transition-colors">
                      <td className="px-3 py-2.5 font-medium text-ot-charade dark:text-dark-text truncate" title={r.author_name}>
                        {r.author_name}
                      </td>
                      ...
                      <td className="px-3 py-2.5 text-gray-500 dark:text-dark-text-secondary truncate" title={r.text || undefined}>

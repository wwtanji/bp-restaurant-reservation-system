  ...
  return (
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        ...
        >
          <div className="flex items-center justify-between px-6 py-4 border-b border-ot-iron flex-shrink-0">
            <div>
              <h3 className="text-lg font-bold text-ot-charade">{images.length} Photos</h3>
            ...
            <button
              ...
              className="text-ot-pale-sky hover:text-ot-charade transition-colors p-1 -mr-1"
            >
